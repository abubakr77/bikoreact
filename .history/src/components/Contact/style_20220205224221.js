...
export const DTitle = styled.h2`
  ...
  margin-bottom: 30px;
`;
export const DSpan = styled.span`
  font-weight: normal;
`;
...
export const FormInput = styled.div`
  overflow: hidden;
`;
export const InputFF = styled.input`
  width: 49%;
`;
export const Submitt = styled(DInput)`
  width: 100%;
  width: 60%;
  background: #fff;
  ...
  cursor: pointer;
`;
export const Submittt = styled(DInput)`
  width: 100%;
`;
export const TexArea = styled.textarea`
  ...
  background: #ccc;
`;
export const InputText = styled(DInput)`
  float: left;
`;
export const InputEmail = styled(DInput)`
  float: right;
`;
