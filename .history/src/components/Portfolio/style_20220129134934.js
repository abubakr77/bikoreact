...
padding-top: 20px;
overflow: hidden;`;
export const PortfolioTit=styled.h2` text-align: center;
font-size: 35px;`;
export const TitleSpan=styled.span`font-weight: normal;`;
export const PortList=styled.ul`list-style: none;
text-align: center;
margin: 20px 0;`;
