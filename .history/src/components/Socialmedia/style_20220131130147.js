...
export const SocialSection=styled.div` height: auto;
overflow: hidden;`;
...
export const Sicon=styled.div`width: 50px;
height: 50px;
background: #fff;
text-align: center;
line-height: 50px;
...
float: left;
margin-right: 10px;`;
export const SocilP=styled.div`font-weight: bold;
text-transform: uppercase;
font-size: 20px;
color: #fff;`;
export const SpSpan=styled.div`display: block;
margin-bottom: 8px;`;
export const Sinfo=styled.div` font-weight: normal;`;
.social-media {
